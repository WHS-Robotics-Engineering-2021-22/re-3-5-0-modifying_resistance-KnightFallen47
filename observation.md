All of the circuts use the same resistors, but they all have different currents. The first is using the resistors separately and share the same power source.
